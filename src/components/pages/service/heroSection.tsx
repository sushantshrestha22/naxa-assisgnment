...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen sm:min-h-150 h-full top-0 right-0 bg-[url(/service_hero_bg.jpg)] bg-cover xl:bg-contain bg-right bg-no-repeat place-content-center py-10">
